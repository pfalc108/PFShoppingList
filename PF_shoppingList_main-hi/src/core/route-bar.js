...
const RouteBar = createVisualComponent({
  ...
  render(props) {
    ...
    const appActionList = [
      ...
      { children: <Lsi import={importLsi} path={["Menu", "listoverview"]} />, onClick: () => setRoute("listoverview") },
      { children: <Lsi import={importLsi} path={["Menu", "shoppinglist"]} />, onClick: () => setRoute("shoppinglist") },
      {
